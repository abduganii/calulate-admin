            ...
            <div className={cls.Login__content}>
                <div className={cls.Login__content__wrap}>
                    <div>
                        ...
                        <p className={cls.Login__text}>Электронный прием заказов на алюминиевые фасады</p>
                        <LoginInput type={"text"} label={"Логин"} placeholder={"Логин"} style={{ marginBottom: "20px" }} />
                        <LoginInput type={"password"} label={"Пароль"} placeholder={"Пароль"} style={{ marginBottom: "67px" }} />
                        <BlueBtn type={"submit"} onClick={() => navigate('/')}>Вход в систему</BlueBtn>
                    </div>
